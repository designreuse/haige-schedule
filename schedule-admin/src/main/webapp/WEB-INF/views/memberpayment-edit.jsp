        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <form role="form" class="form-horizontal" method="post" id="paymentEditForm"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="payPerson" id="payPerson"
                                           value="${payment.payPerson}" placeholder="缴款人姓名">
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="payDate" id="payDate"
                                           value="${payment.payDate}" placeholder="缴款日期">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="payment" id="payment"
                                           value="${payment.payment}" placeholder="缴款金额">
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="purchaseCount" id="purchaseCount"
                                           value="${payment.purchaseCount}" placeholder="充值次数"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea type="text" class="form-control" name="comment" id="comment"
                                              placeholder="备注">${payment.comment}</textarea>
                                </div>
                            </div>
