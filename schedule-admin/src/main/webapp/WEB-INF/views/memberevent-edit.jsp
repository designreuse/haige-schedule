        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <form role="form" class="form-horizontal" method="post" id="eventEditForm"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" readonly class="form-control" name="creator" id="creator"
                                           value="${event.creator}" placeholder="创建人">
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="eventDate" id="eventDate"
                                           value="${event.eventDate}" placeholder="日期">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="costTimes" id="costTimes"
                                           value="${event.costTimes}" placeholder="消耗课时"/>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <textarea type="text" class="form-control" name="comment" id="comment"
                                              placeholder="备注">${event.comment}</textarea>
                                </div>
                            </div>
